...
{
    public partial class NonADM_Screen : Form
    {
        public NonADM_Screen()
        {
            InitializeComponent();
        ...
        private void NonADM_Screen_MouseUp(object sender, MouseEventArgs e)
        {
            Arrastando = false;
        }

        private void NonADM_Screen_MouseDown(object sender, MouseEventArgs e)
        {
            Arrastando = true;
        ...
        private void NonADM_Screen_MouseMove(object sender, MouseEventArgs e)
        {
            if (Arrastando == true)
            {
        ...
        private void NonADM_Screen_Load(object sender, EventArgs e)
        {
